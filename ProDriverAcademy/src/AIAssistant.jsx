...
import { useToast } from "leolalibrary/src/hooks/use-toast"
import { useSpeech } from "@/hooks/use-speech"

export const AIAssistant = ({ onGenerateVariants, onUpdateComponent }) => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      if (aiResponse.action === 'create' && aiResponse.components) {
        ...
        const targetId = aiResponse.modifications.targetId;
        if (targetId) {
